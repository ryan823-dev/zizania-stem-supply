  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Industrial variants for ZizaniaStem
        industrial: "bg-primary text-primary-foreground hover:bg-primary/95 border-0",
        "industrial-outline": "border-2 border-primary text-primary bg-transparent hover:bg-primary hover:text-primary-foreground",
        "industrial-ghost": "text-foreground hover:text-primary underline underline-offset-4 decoration-muted-foreground hover:decoration-primary",
